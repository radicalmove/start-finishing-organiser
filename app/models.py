...
class RitualEntry(Base):
    ...
    morning_right_now = Column(Text, nullable=True)
    morning_email_plan = Column(Text, nullable=True)
    morning_focus_chunk = Column(Text, nullable=True)
    ...
    midday_alignment = Column(String(40), nullable=True)
    midday_surprises = Column(Text, nullable=True)
    midday_one_thing = Column(Text, nullable=True)
    midday_frog = Column(Text, nullable=True)
    aar_went_well = Column(Text, nullable=True)
    aar_hard = Column(Text, nullable=True)
    aar_next_step = Column(Text, nullable=True)
    wins = Column(Text, nullable=True)
    adjustments = Column(Text, nullable=True)
    evening_shutdown = Column(Text, nullable=True)
    evening_breadcrumbs = Column(Text, nullable=True)
