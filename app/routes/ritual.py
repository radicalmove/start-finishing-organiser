...
def save_ritual(
    ...
    morning_right_now: str | None = Form(None),
    morning_email_plan: str | None = Form(None),
    morning_focus_chunk: str | None = Form(None),
    ...
    midday_alignment: str | None = Form(None),
    midday_surprises: str | None = Form(None),
    midday_one_thing: str | None = Form(None),
    midday_frog: str | None = Form(None),
    aar_went_well: str | None = Form(None),
    aar_hard: str | None = Form(None),
    aar_next_step: str | None = Form(None),
    wins: str | None = Form(None),
    adjustments: str | None = Form(None),
    evening_shutdown: str | None = Form(None),
    evening_breadcrumbs: str | None = Form(None),
    ...
    entry = RitualEntry(
        ...
        morning_right_now=morning_right_now or None,
        morning_email_plan=morning_email_plan or None,
        morning_focus_chunk=morning_focus_chunk or None,
        ...
        midday_alignment=midday_alignment or None,
        midday_surprises=midday_surprises or None,
        midday_one_thing=midday_one_thing or None,
        midday_frog=midday_frog or None,
        aar_went_well=aar_went_well or None,
        aar_hard=aar_hard or None,
        aar_next_step=aar_next_step or None,
        wins=wins or None,
        adjustments=adjustments or None,
        evening_shutdown=evening_shutdown or None,
        evening_breadcrumbs=evening_breadcrumbs or None,
